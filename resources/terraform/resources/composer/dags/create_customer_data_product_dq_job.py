...
### Customer Data Product Quality Job 
    ...
    create_dataplex_dq_check_task = DataplexCreateTaskOperator(
        ...
        body={
            ...
            "spark": {
                    "file_uris": [f"gs://dataplex-clouddq-artifacts-{DATAPLEX_REGION}/clouddq-executable.zip", f"gs://dataplex-clouddq-artifacts-{DATAPLEX_REGION}/clouddq-executable.zip.hashsum", f"{INPUT_DQ_YAML}"],
                    "python_script_file": f"gs://dataplex-clouddq-artifacts-{DATAPLEX_REGION}/clouddq_pyspark_driver.py",

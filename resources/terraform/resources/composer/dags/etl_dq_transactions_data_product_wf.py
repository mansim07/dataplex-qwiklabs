...
#                },
#            "spark": {
#                    "file_uris": [f"gs://dataplex-clouddq-artifacts-{DATAPLEX_REGION}/clouddq-executable.zip", "gs://dataplex-clouddq-artifacts-{DATAPLEX_REGION}/clouddq-executable.zip.hashsum", f"{INPUT_DQ_YAML}"],
#                    "python_script_file": 'gs://dataplex-clouddq-artifacts-{DATAPLEX_REGION}/clouddq_pyspark_driver.py',

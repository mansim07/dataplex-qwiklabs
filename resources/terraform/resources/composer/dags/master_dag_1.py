...
with DAG(
    ...
    externalsensor1 = TriggerDagRunOperator(
        task_id='master_customer-end-to-end-dp',
        trigger_dag_id='master_customer-end-to-end-dp',
    ...
    externalsensor2 = TriggerDagRunOperator(
        task_id='master_merchant-end-to-end-dp',
        trigger_dag_id='master_merchant-end-to-end-dp',
        #external_task_id=None,  # wait for whole DAG to complete
        #check_existence=True,
        wait_for_completion=True
        #timeout=120
    ...
    externalsensor3 = TriggerDagRunOperator(
        task_id='master-trans-end-to-end-dp',
        trigger_dag_id='master-trans-end-to-end-dp',
        #external_task_id=None,  # wait for whole DAG to complete
        #check_existence=True,
         wait_for_completion=True
        #timeout=120

...
with DAG(
    ...
    externalsensor1 = TriggerDagRunOperator(
        task_id='data_governance_customer_classification_tag',
        trigger_dag_id='data_governance_customer_classification_tag',
    ...
    externalsensor2 = TriggerDagRunOperator(
        task_id='data_governance_merchant_classification_tag',
        trigger_dag_id='data_governance_merchant_classification_tag',
        #external_task_id=None,  # wait for whole DAG to complete
        #check_existence=True,
        wait_for_completion=True
        #timeout=120
    ...
    externalsensor3 = TriggerDagRunOperator(
        task_id='data_governance_transactions_classification_tag',
        trigger_dag_id='data_governance_transactions_classification_tag',
        #external_task_id=None,  # wait for whole DAG to complete
        #check_existence=True,
         wait_for_completion=True
        #timeout=120
    ...
    dq_start >> externalsensor1 >> externalsensor2 >> externalsensor3  >> dq_complete